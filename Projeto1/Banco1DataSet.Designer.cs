...
namespace Projeto1 {
    ...
    public partial class Banco1DataSet : global::System.Data.DataSet {
        ...
        public partial class usuariosDataTable : global::System.Data.TypedTableBase<usuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public usuariosRow AddusuariosRow(int codigo, string nome, string senha) {
...
namespace Projeto1.Banco1DataSetTableAdapters {
    ...
    public partial class usuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[usuarios] WHERE (([codigo] = @Original_codigo) AND ([nome] = @" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[usuarios] ([codigo], [nome], [senha]) VALUES (@codigo, @nome, " +
                "@senha);\r\nSELECT codigo, nome, senha FROM usuarios WHERE (codigo = @codigo)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[usuarios] SET [codigo] = @codigo, [nome] = @nome, [senha] = @senha " +
                "WHERE (([codigo] = @Original_codigo) AND ([nome] = @Original_nome) AND ([senha] " +
                "= @Original_senha));\r\nSELECT codigo, nome, senha FROM usuarios WHERE (codigo = @" +
                "codigo)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Projeto1.Properties.Settings.Default.Banco1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT codigo, nome, senha FROM dbo.usuarios";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT codigo, nome, senha FROM dbo.usuarios";
        ...
        public virtual int Fill(Banco1DataSet.usuariosDataTable dataTable) {
        ...
        public virtual Banco1DataSet.usuariosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Banco1DataSet.usuariosDataTable dataTable = new Banco1DataSet.usuariosDataTable();
        ...
        public virtual int FillBy(Banco1DataSet.usuariosDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Banco1DataSet.usuariosDataTable dataTable) {
